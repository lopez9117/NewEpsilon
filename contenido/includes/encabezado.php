<?php include("../validate/ValidateSecurity.php"); ?>
        ...
        <td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="class_tr_top">
                    <td width="1%">&nbsp;</td>
                    <td width="8%">
                        <table class="class_tr" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    <div class="img_inicio" sr></div>
                                </td>
                                <td>&nbsp;
	...
	<a href="main_menu.php" target="main">Pendientes<span id="notificacion" style="margin-left:5px;"></span></a>       
                    ...
                    <td width="11%">
                        <table class="class_tr" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td nowrap="nowrap">&nbsp;
                                    <a href="../contenido/MiCuenta/MyAcount.php?User=<?php echo base64_encode($CurrentUser) ?>"
                                       target="main">Mi cuenta</a>
                                    &nbsp;</td>
                            </tr>
                        </table>
                    </td>
