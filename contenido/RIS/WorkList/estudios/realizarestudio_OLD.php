...
//registrar el worlist
    mysql_query("UPDATE r_worklist_temp SET procesado='4', observacion= '$observaciones' WHERE idestudio=$idInforme", $cn) or showerror(mysql_error(), 7);
	mysql_query("INSERT INTO r_estadistica (id_informe, mas, kv, i_danadas, r_innecesarias, total_dosis) VALUES('$idInforme','$MAS','$KV','$i_dañadas','$r_innecesarias','$Dosis')", $cn);
