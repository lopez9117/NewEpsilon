...
<body>
<form id="observacion" name="observacion" method="post" action="AccionAddEventoAdverso.php">
<fieldset>
<legend><strong>Eventos Adversos</strong>
...
<tr>
  <td colspan="2" bgcolor="#CCCCCC" style="color:#333"><strong>Evento:</strong></td>
</tr>
<tr>
  <td colspan="2"><textarea name="observacion" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; width:99%;" rows="3" cols="60"></textarea></td>
</tr>
<tr>
  ...
  <td width="50%" align="right"><input type="button" value="Registrar Evento" onClick="enviarObservacion()" /></td>
</tr>
</table>
</fieldset>
</form>
...
{
	echo '<tr><td>No se han regostrado eventos adversos...</td></tr>';
}
else
{
