...
<form name="VerAgenda" id="VerAgenda" method="post">
    <table width="100%">
        ...
        <tr>
            <td><input type="text" id="datepicker2" name="fechaDesde" class="calendar" value="<?php echo $nuevafecha; ?>" onChange="CargarAgenda()" readonly/><span class="asterisk">*</span></td>
            <td><label for="fecha"></label><input type="text" id="datepicker" name="fechaHasta" class="calendar" value="<?php echo $hoy; ?>" onChange="CargarAgenda()" readonly/><span class="asterisk">*</span></td>
            ...
            <td>
                ...
                <div align="right" style="position:relative;"><img src="../../../../images/reload.png" width="24" height="24" title="Recargar" alt="Recargar" onClick="CargarAgenda()"></div>
            </td>
        </tr>
    </table>
    <table width="100%">
