$(function(){
	...
	$('.clsVentanaCerrar2').live('click',function(eEvento){
		...
		$objVentana.fadeOut(300,function(){
			...
			$('#divOverlay2').fadeOut(500,function(){
	...
	$('.clsVentanaIFrame2').on('click',function(eEvento){
		...
		var $objVentana=$('<div class="clsVentana2">'), $objVentanaTitulo=$('<div class="clsVentanaTitulo2">');
		
		//agregamos el titulo establecido y el boton cerrar
		$objVentanaTitulo.append('<strong>'+strTitulo+'</strong>');
		$objVentanaTitulo.append('<a href="" class="clsVentanaCerrar2">Cerrar</a>');
		...
		var $objOverlay=$('<div id="divOverlay2">').css({
			opacity: .5,
			display: 'none'
		});
