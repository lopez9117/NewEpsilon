...
$(function(){
	$('#especialista').autocomplete({
	   source : 'QueryEspecialistas/buscadorEspecialistas.php',
...
<form name="AgendaEspecialista" id="AgendaEspecialista" method="post">
  <table width="100%">
    <tr bgcolor="#E1DFE3">
      ...
      <td colspan="4"><label for="especialista"></label>
      <input type="text" name="especialista" id="especialista" onFocus="BuscarEspecialista()"></td>
    </tr>
    <tr bgcolor="#E1DFE3">
