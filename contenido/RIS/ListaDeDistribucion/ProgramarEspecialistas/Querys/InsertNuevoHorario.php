...
{
	//insertar
	mysql_query("INSERT INTO r_horario_especialista (idfuncionario, fecha, hr_desde, hr_hasta, idsede, idservicio, idAut) VALUES ('$idEspecialista','$fechaDesde','$desde','$hasta','$sede','$servicio','')", $cn);
}
?>