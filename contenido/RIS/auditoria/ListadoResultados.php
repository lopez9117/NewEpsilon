...
WHERE i.id_informe = '$idInforme'", $cn);
	...
	echo '<td align="center"><a href="ReturnPaciente.php?&idInforme='.base64_encode($idInforme).'&estadoinforme='.base64_encode($estado).'&user='.base64_encode($usuario).'" target="popup" onClick="window.open(this.href, this.target, width=600,height=800); return false;"><img src="../../../images/reload.png" width="15" height="15" title="Regresar Estudio" alt="Regresar Estudio" /></a></td>';
	echo '</tr>';
}
mysql_close($cn);
?>
