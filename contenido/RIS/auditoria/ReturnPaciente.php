...
$sql = mysql_query("SELECT i.id_paciente, i.id_estadoinforme, CONCAT(p.nom1,' ',p.nom2,' ',p.ape1,' ',p.ape2) AS paciente, est.nom_estudio, pri.desc_prioridad, tec.desc_tecnica, es.desc_estado FROM r_informe_header i
...
function Validar()
{
	...
	if(est_devolulcion=="0" || observacion=="" )
	{
