...
i.portatil, i.orden, i.desc_extremidad, p.nom1, p.nom2,p.ape1, p.ape2, p.edad,
...
WHERE i.id_informe = '$idInforme' AND l.id_estadoinforme = '5' AND i.id_estadoinforme = '5'", $cn);
...
<table width="100%" border="1" rules="all">
	...
	<tr>
                ...
                <td><strong>N° Orden:</strong> <?php echo $regHeader['orden']?> </td>
              </tr>
    <tr class="fondo">>
...
<tr>
	<td><strong>Notas aclaratorias</strong></td>
</tr>
<tr>
	<td>&nbsp;</td>
</tr>';
while($rowNotas = mysql_fetch_array($consNotas))
{
	echo 
	'<tr>
	<td><strong>Especialista</strong>: '.ucwords(strtolower($rowNotas['especialista'])).' / '.$rowNotas['Fecha_Hora'].'</td>
	</tr>
	<tr>
	<td>'.$rowNotas['detalle_nota'].'</td>
	</tr>';
}
echo '</table>';
}
