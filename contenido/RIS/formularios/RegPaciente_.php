...
if ($documento == "") {
    ...
    <form name="nuevo_informe" id="nuevo_informe" method="post" action="Inserts/RegDatosPaciente.php"
                    ...
                    <td width="16%"><strong>Tipo documento</strong><br><label for="tipo_documento"></label>
                        <select name="tipo_documento" class="textlarge">
                            ...
                            while ($rowtipoDocumento = mysql_fetch_array($listaTipoDocumento)) {
                                echo '<option value="' . $rowtipoDocumento['idtipo_documento'] . '">' . $rowtipoDocumento['desc_tipodocumento'] . '</option>';
                            }
                            ?>
...
<!--                        <input type="text" name="unidadedad" id="unidadedad2" size="13"  />-->
                    ...
                    <td colspan="2"><strong>EPS / E-EPS</strong><br><label for="eps"></label>
                        ...
                        $conEps = mysql_query("SELECT ideps, UPPER(desc_eps) AS desc_eps FROM eps WHERE ideps = '$regpaciente[ideps]' AND idestado = '2'", $cn);
                        ...
                        <?php
                            ...
                            <input type="text" name="VistaEps" id="VistaEps"
                                   ...
                                   style="width:80%; font-family:Arial, Helvetica, sans-serif; font-size:11px;"
                                   placeholder="Ingrese nombre de la EPS" onBlur="ValidarEps()"
                                   value="<?php echo utf8_decode($regEps['desc_eps']) ?>"/><span
                                class="asterisk">*</span>
                            <input type="hidden" name="ideps" id="ideps" value="<?php echo $regEps['ideps'] ?>"><span
                                class="asterisk">*</span>
                        <?php
                        }
                        ?>
                        ...
                        <tr>
                            <td width="30%">
                                ...
                                <select name="dep" id="dep" onChange="cargarMunicipio()" class="textNormal">
                                    ...
                                    ?>
                                </select><span id="validar_departamento" class="asterisk" style="display: none">*</span></td>
                            <td width="20%"><label for="municipio"></label>
                                ...
                                <select name="mun" id="mun" class="textNormal">
                                    ...
                                    ?>
                                </select><span id="validar_municipio" class="asterisk" style="display: none">*</span></td>
                            <td width="16%"><label for="barrio"></label>
                                ...
                                <input name="barrio" type="text" id="barrio"
                                       ...
                                       class="textNormal" placeholder="Barrio"/><span id="validar_barrio" class="asterisk" style="display: none">*</span></td>
                            <td width="16%"><label for="direccion"></label>
                                ...
                                <input name="direccion" id="direccion" type="text"
                                       ...
                                       class="textNormal" placeholder="Direcci�n del domicilio"/><span id="validar_direccion" class="asterisk" style="display: none">*</span></td>
                            <td width="20%"><strong>Tel / movil</strong><br><label for="tel"></label>
                                ...
                                <input name="movil" type="text" value="<?php echo $cel; ?>" class="textlarge"
                                       placeholder="Movil"/> <span id="validar_telefono" class="asterisk" style="display: none">*</span></td>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td id="Estudios" colspan="2"><strong>Estudio</strong><br/>
                            <input type="text" name="Vistaestudio" id="Vistaestudio"
                                   style="width:87%; font-family:Arial, Helvetica, sans-serif; font-size:11px;"
                                   placeholder="Ingresar nombre del estudio o procedimiento" disabled/>
                            <span class="asterisk">*</span></td>
                    ...
                    <tr>
                        <td id="tecnicaestudio"><strong>Tecnica</strong><br/>
                            <select name="tecnica" id="tecnica" class="text" onBlur="ValidarEstudio()" onChange="ValidarEstudio()">
                                <?php
                    ...
                    <tr>
                        <td id="valilado"><strong>Lado</strong><br/>
                            ...
                            <span class="asterisk">*</span></td>
                        <td id="descripcion_extremidad"><strong>Extremidad:</strong><br><input type="text" name="Extremidad" class="text"
                                                                   placeholder="Ejemplo:(Mano, Pie, Cuello de pie, Muñeca, entre otros...)"
                                                                   onKeyUp="this.value=this.value.toUpperCase()"
                                                                   onFocus="BuscarExtremidad()" id="Extremidad"/></td>
            ...
            <fieldset>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td id="Estudios1" colspan="2"><strong>Estudio</strong><br/>
                            <input type="text" name="Vistaestudio1" id="Vistaestudio1"
                                   style="width:87%; font-family:Arial, Helvetica, sans-serif; font-size:11px;"
                                   placeholder="Ingresar nombre del estudio o procedimiento" disabled/>
                            <span class="asterisk">*</span></td>
                    ...
                    <tr>
                        <td id="valilado1"><strong>Lado</strong><br/>
                            ...
                            <span class="asterisk">*</span></td>
                        <td id="descripcion_extremidad1"><strong>Extremidad:</strong><br/><input type="text" name="Extremidad1" id="extremidad1" class="text"
                                                                   placeholder="Ejemplo:(Mano, Pie, Cuello de pie, Muñeca, entre otros...)"
                                                                   onKeyUp="this.value=this.value.toUpperCase()"
                                                                   onFocus="BuscarExtremidad()"/></td>
                        <td width="24%"><strong>Adicional:</strong><br/>
