...
if(fecha == "" || sede == "" || servicio == "" || estado =="" || hasta == "")
{
...
else
{
	...
	function verlistado(){ //FUNCION PARA MOSTRAR EL LISTADO EN EL INDEX POR JQUERY
		...
		$.post("ListadoResultados.php?fecha="+fecha+"&sede="+sede+"&servicio="+servicio+"&estado="+estado+"&hasta="+hasta+"&usuario="+usuario+"", {
...
<div id="tabs">
<ul>
<li><a href="#tabs-1">Auditoria</a></li>
</ul>
<div id="tabs-1">
<div id="contenido">
...
<td width="22%"><strong>Sede:</strong><br>
  ...
  <td width="22%"><strong>Servicio:</strong><br> 
	<label for="servicio"></label>
	<select name="servicio" id="servicio" onchange="consultar()" class="text">
	  <option value="">.: Seleccione :.</option>
	  <?php
