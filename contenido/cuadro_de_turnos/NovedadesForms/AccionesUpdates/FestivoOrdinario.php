...
if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
{
	...
	mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','','0','$t_horas_2','$t_horas_4','$t_horas_3','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
...
else
{
	if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin>$ref_diurna)
	{
		...
		$t_horas_nocturnas = $t_horas_3 + $t_horas_4;
		mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','','$t_horas_5','$t_horas_2','$t_horas_4','$t_horas_3','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
		mysql_query("INSERT INTO novedad_turno VALUES ('$idturno','$desde','$hasta','0',0','0','0','$CurrentUser','$nota','$evento')",$cn);
	}
	else
	{
		if($ini>=$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
		{
			...
			mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','','0','0','$t_horas_3','$t_horas_2','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
			mysql_query("INSERT INTO novedad_turno VALUES ('$idturno','$desde','$hasta','0','0','0','0','$CurrentUser','$nota','$evento')",$cn);
		}
		else
		{
			if($ini>=$ref_nocturna && $fin>$ref_cambio && $fin>$ref_diurna && $fin<=$ref_nocturna )
			{
				...
				mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','','$t_horas_4','0','$t_horas_3','$t_horas_2','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
				mysql_query("INSERT INTO novedad_turno VALUES ('$idturno','$desde','$hasta','0','0','0','0','$CurrentUser','$nota','$evento')",$cn);
			}
		}
	}
}
//echo 'Festivo Ordinario';
?>