...
if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
{
	...
	mysql_query("DELETE FROM turno_funcionario WHERE idturno = '$idturno'");
	mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','','0','$t_horas_diurnas','0','$t_horas_nocturnas','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
	mysql_query("INSERT INTO novedad_turno VALUES('$idturno','$desde','$hasta','0','0','0','0','$CurrentUser','$nota','$evento')");
}
else
{
	if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin>$ref_diurna)
	...
	else
	{
		if($ini>=$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
		{
			...
			mysql_query("DELETE FROM turno_funcionario WHERE idturno = '$idturno'");
			mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','','0','0','0','$t_horas_nocturnas','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
		...
		else
		{
			if($ini>=$ref_nocturna && $fin>$ref_cambio && $fin>$ref_diurna && $fin<=$ref_nocturna )
			{
				...
				mysql_query("DELETE FROM turno_funcionario WHERE idturno = '$idturno'");
				mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','','0','$t_horas_diurnas','0','$t_horas_nocturnas','$idConvencion','$sede'),'$grupoEmpleado','$servicio'");
				mysql_query("INSERT INTO novedad_turno VALUES('$idturno','$desde','$hasta','0','0','0','0','$CurrentUser','$nota','$evento')",$cn);
			}
		}
	}
}
//echo 'Festivo Festivo';
?>