...
if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
{
	...
	mysql_query("INSERT INTO turno_funcionario (idturno, idfuncionario, hr_inicio, hr_fin, fecha, currentuser, idtipo_turno, diurna, diurnafest, nocturna, nocturnafest, idConvencion, idsede, idgrupo_empleado, idservicio, hralmuerzo) VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','0','$t_horas_2','0','$t_horas_3','$t_horas_4','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
	mysql_query("INSERT INTO novedad_turno 
(idturno, hr_inicio, hr_fin, diurnas_adicionales, nocturnas_adicionales, diurfest_adicionales, nocfest_adicionales, currentuser, nota, evento_adverso)
VALUES('$idturno','$desde','$hasta','0','0','0','0','$CurrentUser','$nota','$evento')",$cn);
}
else
{
	if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin>$ref_diurna)
	{
		...
		$t_horas_nocturnas = $t_horas_3 + $t_horas_4;
		mysql_query("INSERT INTO turno_funcionario (idturno, idfuncionario, hr_inicio, hr_fin, fecha, currentuser, idtipo_turno, diurna, diurnafest, nocturna, nocturnafest, idConvencion, idsede, idgrupo_empleado, idservicio, hralmuerzo) VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','0','$t_horas_2','$t_horas_5','$t_horas_3','$t_horas_4','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
		mysql_query("INSERT INTO novedad_turno 
(idturno, hr_inicio, hr_fin, diurnas_adicionales, nocturnas_adicionales, diurfest_adicionales, nocfest_adicionales, currentuser, nota, evento_adverso)
VALUES('$idturno','$desde','$hasta','0','0','0','0','$CurrentUser','$nota','$evento')",$cn);
	}
	else
	{
		if($ini>=$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
		{
			...
			mysql_query("INSERT INTO turno_funcionario (idturno, idfuncionario, hr_inicio, hr_fin, fecha, currentuser, idtipo_turno, diurna, diurnafest, nocturna, nocturnafest, idConvencion, idsede, idgrupo_empleado, idservicio, hralmuerzo) VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','0','0','0','$t_horas_2','$t_horas_3','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
			mysql_query("INSERT INTO novedad_turno 
(idturno, hr_inicio, hr_fin, diurnas_adicionales, nocturnas_adicionales, diurfest_adicionales, nocfest_adicionales, currentuser, nota, evento_adverso)
VALUES('$idturno','$desde','$hasta','0','0','0','0','$CurrentUser','$nota','$evento')",$cn);
		}
		else
		{
			if($ini>=$ref_nocturna && $fin>$ref_cambio && $fin>$ref_diurna && $fin<=$ref_nocturna )
			{
				...
				mysql_query("INSERT INTO turno_funcionario (idturno, idfuncionario, hr_inicio, hr_fin, fecha, currentuser, idtipo_turno, diurna, diurnafest, nocturna, nocturnafest, idConvencion, idsede, idgrupo_empleado, idservicio, hralmuerzo) VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','0','0','$t_horas_4','$t_horas_2','$t_horas_3','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
				mysql_query("INSERT INTO novedad_turno 
(idturno, hr_inicio, hr_fin, diurnas_adicionales, nocturnas_adicionales, diurfest_adicionales, nocfest_adicionales, currentuser, nota, evento_adverso)
VALUES('$idturno','$desde','$hasta','0','0','0','0','$CurrentUser','$nota','$evento')",$cn);
			}
