...
if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
{
	...
	mysql_query("INSERT INTO novedad_turno VALUES ('$idturno','$desde','$hasta','0','$t_horas_2','$t_horas_4','$t_horas_3','$CurrentUser','$nota','$evento')",$cn);
}
else
{
	if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin>$ref_diurna)
	{
		...
		$t_horas_nocturnas = $t_horas_3 + $t_horas_4;
		mysql_query("INSERT INTO novedad_turno VALUES ('$idturno','$desde','$hasta','$t_horas_5','$t_horas_2','$t_horas_4','$t_horas_3','$CurrentUser','$nota','$evento')",$cn);
	}
	else
	{
		if($ini>=$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
		{
			...
			mysql_query("INSERT INTO novedad_turno VALUES ('$idturno','$desde','$hasta','0','$t_horas_3','0','$t_horas_2','$CurrentUser','$nota','$evento')",$cn);
		}
		else
		{
			if($ini>=$ref_nocturna && $fin>$ref_cambio && $fin>$ref_diurna && $fin<=$ref_nocturna )
			{
				...
				mysql_query("INSERT INTO novedad_turno VALUES ('$idturno','$desde','$hasta','$t_horas_4','0','$t_horas_3','$t_horas_2','$CurrentUser','$nota','$evento')",$cn);
			}
		}
	}
}
