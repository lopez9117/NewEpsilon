...
if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
{
	...
	mysql_query("INSERT INTO novedad_turno VALUES('$idturno','$desde','$hasta','$t_horas_diurnas','$t_horas_nocturnas','0','0','$CurrentUser','$nota','$evento')",$cn);
}
else
{
	if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin>$ref_diurna)
	...
	else
	{
		if($ini>=$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
		{
			...
			mysql_query("INSERT INTO novedad_turno VALUES('$idturno','$desde','$hasta','0','$t_horas_nocturnas','0','0','$CurrentUser','$nota','$evento')",$cn);
		}
		else
		{
