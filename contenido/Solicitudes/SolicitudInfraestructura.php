...
<form action="insert/insert_infraestructura.php" method="post" enctype="multipart/form-data"
                  name="Newregistro" id="Newregistro">
                 <h4 align="center"><strong>Realizar Solicitud Infraestructura</strong></h4>
    <div class="row">
