...
<tr><td width="260" height="270" align="center" valign="middle">
    ...
    <form action="update_solicitudEnProceso_Compras.php" method="post" name="Newregistro" id="Newregistro">
    <table width="100%" height="100%">
      <tr>
        <th><h1>&iquest;Como va la Solicitud?</h1>
        <tr>
      <tr>
      <td height="126"><span id="sprytextarea1">
