...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="ListadoSedes">
    ...
    <tr>
        ...
        <th align="center" width="12%">Produccion</th>
        <th align="center" width="12%">Estudios Cancelados</th>
        <th align="center" width="12%">Devueltos General</th>
        <th align="center" width="12%">Devueltos Especialista</th>
        <th align="center" width="12%">Dosis Radiación</th>
        <th align="center" width="12%">reporte Oprotunidad</th>
        <th align="center" width="12%">reporte Contraste</th>
    </tr>
</thead>
<tfoot>
    <tr>
...
$XlsIco = 'src="../../images/excel.png" width="20" height="20"';
    ...
    echo '<td align="center"><a href="reportecontraste.php'.$VarUrl.'"><img '.$XlsIco.' alt="Descargar Reporte Contraste" title="Descargar Reporte Contraste" /></a></td>';
	echo '</tr>';
?>
<tbody>
</table>