<?php
	...
	//consulta para obtener la cantidad de funcionarios que interveienen en el servicio de una sede especifica
	...
	WHERE t.fecha BETWEEN '$fechaInicio' AND '$fechaStop' AND t.idsede = '$sede' AND idsede = '$sede' AND t.idservicio = '$servicio'
...
<title>.: Reporte Sede & Servicio :.</title>
<style type="text/css">
	body
	{font-size:10px;
...
WHERE t.idfuncionario = '$docFuncionario' AND t.fecha BETWEEN '$fechaInicio' AND '$fechaStop' AND t.idservicio = '$servicio'", $cn);
