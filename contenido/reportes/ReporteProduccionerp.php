...
WHERE i.erp= '$iderp'  AND l.fecha BETWEEN '$desde' AND '$hasta' AND l.id_estadoinforme = '8' ORDER BY i.idservicio ASC", $cn);
...
WHERE i.erp = '$iderp'  AND l.fecha BETWEEN '$desde' AND '$hasta' AND i.id_estadoinforme = '10'  ORDER BY i.idservicio ASC", $cn);
