...
function Validar()
{
	...
	else
	{
		...
		$.post("UsuariosSatisfechos.php?encuesta="+encuesta+"&anio="+anio+"&sede="+sede+"&mes="+mes+"", {
...
<form id="Global" name="Global" method="post" action="#">
  <table width="90%" border="0" align="center">
    ...
    <tr>
      ...
      <td><select name="mes" class="input">
      <option value="">.: Seleccione :.</option>
      <?php
    ...
    <tr>
      <td colspan="5" id="contenido"><label for="anio"></label></td>
    </tr>
  </table>
</form>
</fieldset>
