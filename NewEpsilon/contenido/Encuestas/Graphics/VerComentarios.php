...
function Validar()
{
	...
	else
	{
		...
		$.post("ConsolidadoComentarios.php?encuesta="+encuesta+"&anio="+anio+"&sede="+sede+"&mes="+mes+"", {
...
<form id="Comentarios" name="Comentarios" method="post" action="">
  <table width="90%" border="0" align="center">
    ...
    <tr>
      <td width="25%"><select name="encuesta" id="encuesta" class="input">
      ...
      <td width="25%"><select name="mes" id="mes" class="input">
        <option value="">.: Seleccione :.</option>
        <?php
