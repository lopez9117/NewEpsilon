$(function(){
	...
	$('.clsVentanaCerrar3').live('click',function(eEvento){
		...
		$objVentana.fadeOut(300,function(){
			...
			$('#divOverlay3').fadeOut(500,function(){
	...
	$('.clsVentanaIFrame3').on('click',function(eEvento){
		...
		var $objVentana=$('<div class="clsVentana3">'), $objVentanaTitulo=$('<div class="clsVentanaTitulo3">');
		
		//agregamos el titulo establecido y el boton cerrar
		$objVentanaTitulo.append('<strong>'+strTitulo+'</strong>');
		$objVentanaTitulo.append('<a href="" class="clsVentanaCerrar3">Cerrar</a>');
		...
		var $objOverlay=$('<div id="divOverlay3">').css({
			opacity: .5,
			display: 'none'
		});
