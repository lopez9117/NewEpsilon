...
<title>.: Nueva Nota Aclaratoria :.</title>
<script type="text/javascript" src="../../../js/ajax.js"></script>
<script type="text/javascript" src="../../../js/jquery.js"></script>
<script type="text/javascript" src="../WorkList/ckeditor/ckeditor.js"></script>
...
<tr>
	<td colspan="5"><textarea name="1" class="ckeditor"><?php echo $regsInforme['detalle_informe'] ?></textarea></td>
</tr>
<tr>
...
<fieldset>
<legend><strong> Nota Aclaratoria</strong></legend>
...
<table width="100%" align="center">
    <tr>
    <td colspan="2" align="right"><input type="submit" name="button2" id="button2" value="Guardar Nota Aclaratoria"/>
    </td>
    <tr/>
</table>
</form>
