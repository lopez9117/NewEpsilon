...
<div>
	...
	<!--<p><a href="../formularios/Resultados.php?sede=<?php echo $sede ?>&usuario=<?php echo $user ?>" style="cursor:pointer;" target="content">Preliminares</a></p>-->
...
<div>
	...
	<!--<p><a href="../Addendum/NuevoAddemdum.php" style="cursor:pointer;" target="content">Addendum / Addenda</a></p>-->
            ...
            <p><a href="../ListaDeDistribucion/ListaLectura/AsignacionEstudios.php?&usuario=<?php echo $user ?>" style="cursor:pointer;" target="content">Lista de distribución</a></p>
            <p><a href="../ListaDeDistribucion/ProgramarEspecialistas/AsignacionEspecialista.php?&amp;usuario=<?php echo $user ?>" style="cursor:pointer;" target="content">Configurar listas de distribución</a></p>
</div>
<h3>Configuración</h3>
<div>
    ...
    <p><a href="../ListaDeDistribucion/ConfigListas/ConfigurarListas.php" style="cursor:pointer;" target="content">Acceso a listas de trabajo</a></p>
</div>
