...
function validateguiasonload(guia, estudio) {
    if (guia == 1048) {
        $('#selectguiaecografica').show();
        $('#selguiaecografica').val(estudio);
    }
    else if (guia == 166) {
        $('#selectguiatomografica').show();
        $('#selguiatomografica').val(estudio);
    }
}
...
function Guardar(opcion) {
    ...
    } else if (servicio == 5 || servicio == 8 || servicio == 23) {
