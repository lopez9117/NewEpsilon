...
<body>
<form id="observacion" name="observacion" method="post" action="acciones/AccionAddObservacion.php">
<fieldset>
...
<table width="100%" border="0" align="center">
    ...
    <tr>
      <td colspan="2"><strong>Observacion:</strong><input name="tipo_comentario" type="radio" value="1" checked="checked"/>
