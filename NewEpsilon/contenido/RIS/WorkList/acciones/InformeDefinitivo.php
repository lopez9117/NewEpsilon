...
d.detalle_informe, d.adicional, esp.url_firma, tec.desc_tecnica, ext.desc_extremidad AS lado, i.anestesia FROM r_informe_header i
...
<table width="100%" border="1" rules="all">
    ...
    <tr>
        ...
        <td><?php if ($regHeader['anestesia']==1) { ?><strong>Anestesia: </strong>Si<?php } ?></td>
    </tr>
    <tr>
    	<td colspan="2" class="fondo"><strong>EPS / Aseguradora: </strong><?php echo $regHeader['desc_eps']?></td>
    </tr>
    <tr>
...
<tr>
  <td colspan="2"><?php echo $regsTecnica['contenido']?></td>
</tr>
<?php
}
?>
...
<!-- Imprimir informe -->
<?php
echo $string = ereg_replace( ("<p>&nbsp;</p>"), "", $regHeader['detalle_informe'] );
?>
</td>
</tr>
<tr>
...
<?php
//imprimir todas las notas aclaratorias que contenga el informe
if($contNotas>=1)
{
echo 
'<table align="center" class="table">
...
while($rowNotas = mysql_fetch_array($consNotas))
{
	...
	<td width="80%">'.$rowNotas['detalle_nota'].'</td>
	</tr>';
}
echo '</table>';
}
