...
if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
{
	...
	mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','0','$t_horas_diurnas','0','$t_horas_nocturnas','0','$idConvencion','$sede','$grupoEmpleado','$servicio','1')", $cn);
...
else
{
	if($ini>=$ref_diurna && $ini<$ref_nocturna && $fin>$ref_cambio && $fin>$ref_diurna)
	{
		...
		$t_horas_nocturnas = $t_horas_3 + $t_horas_4;
		mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','0','$t_horas_diurnas','0','$t_horas_nocturnas','0','$idConvencion','$sede','$grupoEmpleado','$servicio','1')", $cn);
		mysql_query("INSERT INTO novedad_turno VALUES('$idturno','$desde','$hasta','$t_horas_diurnas','0','0','0','0','$nota','$evento')",$cn);
	}
	else
	{
		if($ini>=$ref_nocturna && $fin>$ref_cambio && $fin<=$ref_diurna)
		{
			...
			mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','0','0','0','$t_horas_nocturnas','0','$idConvencion','$sede','$grupoEmpleado','$servicio','1')", $cn);
			mysql_query("INSERT INTO novedad_turno VALUES('$idturno','$desde','$hasta','0','0','0','0','$CurrentUser','$nota','$evento')",$cn);
		}
		else
		{
