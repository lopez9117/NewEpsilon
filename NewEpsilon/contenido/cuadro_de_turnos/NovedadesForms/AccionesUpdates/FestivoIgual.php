...
if($ini>=$ref_cambio && $fin<=$ref_diurna && $fin>$ini)
{
	...
	mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','','0','0','0','$totalNocturnas','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
...
else
{
	...
	if($ini>=$ref_cambio && $ini<=$ref_diurna && $fin>$ref_diurna && $fin<=$ref_nocturna)
	{
		...
		mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','','0','$totalDiurnas','0','$totalNocturnas','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
		mysql_query("INSERT INTO novedad_turno VALUES ('$idturno','$desde','$hasta','0','0','0','0','$CurrentUser','$nota','$evento')",$cn);
	}
	else
	{
		...
		if($ini>=$ref_diurna && $fin<=$ref_nocturna && $fin!=$ref_cambio && $fin>$ini)
		{
			...
			mysql_query("INSERT INTO turno_funcionario VALUES('$idturno','$funcionario','$hora_ini','$hora_fin','$fecha','$CurrentUser','','0','$totalDiurnas','0','0','$idConvencion','$sede','$grupoEmpleado','$servicio','1')");
			mysql_query("INSERT INTO novedad_turno VALUES ('$idturno','$desde','$hasta','0','0','0','0','0','$nota','$evento')",$cn);
		}
		else
		{
